 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | TAB    |   Q  |   W  |   E  |   R  |   T  | CAPS |           |  TX  |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           | BOLT |------+------+------+------+------+--------|
...
[BASE] = KEYMAP(  // layer 0 : default
      ...
      KC_BSPC,        SFT_T(KC_A),  CTL_T(KC_S),   ALT_T(KC_D),   GUI_T(KC_F),   KC_G,
        KC_EQL,        KC_Z,  KC_X,   KC_C,   KC_V,   KC_B,   KC_TRNS,
        LT(SYMB,KC_GRV),KC_QUOT,      LALT(KC_LSFT),  KC_LEFT, MO(NUM),
...
[NUM] = KEYMAP(
       ...
       KC_TRNS,KC_TRNS,KC_TRNS,  KC_TRNS,KC_CAPS,KC_TRNS,KC_TRNS,
       ...
       KC_TRNS, KC_PLUS, KC_7,   KC_8,    KC_9,    KC_BSLS, KC_TRNS,
                         KC_ESC,KC_DOT,  KC_0,    KC_EQL,  KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
),
